...
cdef class MultiDiGraph:
    cdef unordered_map[string, unordered_map[string, unordered_map[string, int]]] _edge_data
    cdef unordered_map[string, int] _node_data  # assuming int data type for node_data values

    def __init__(self, node_data: dict, edge_data: dict):
        self._node_data = <unordered_map[string, int]> node_data
        self._edge_data = unordered_map[string, unordered_map[string, unordered_map[string, int]]]()
